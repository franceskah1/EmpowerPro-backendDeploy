...
public class EmailService {
    ...
    public void send(String to, String email) {
        try {
            ...
            helper.setFrom(new InternetAddress("smsassistance.sparklab@gmail.com", "SMS"));
            helper.setTo(to);
            helper.setSubject("SMS Notification");
            ...
            LOGGER.error("" +
                    "" +
                    "Exception: Failed to send the email", e);
    ...
    public String buildEmail(String name, String link) {
        return "<body marginheight=\"0\" topmargin=\"0\" marginwidth=\"0\" style=\"margin: 0px; background-color: #f2f3f8;\" leftmargin=\"0\">\n" +
                ...
                "                    <tr>\n" +
                "                        <td style=\"text-align:center;\">\n" +
                "                            <p style=\"font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;\">&copy; <strong>EmpowerPro</strong></p>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td style=\"height:80px;\">&nbsp;</td>\n" +
